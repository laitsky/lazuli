...
The separate ingest Worker probes the API through its workers.dev service-isolation URL and
submits a signed, origin-constrained result to the API; the API never recursively fetches itself.

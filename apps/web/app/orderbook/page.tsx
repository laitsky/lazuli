...
export default function OrderBookPage() {
  ...
  const bidAskRatio = totalBidVolume + totalAskVolume > 0
            ...
            <div className="space-y-3">
              ...
              <div className="flex p-1 bg-muted/50 rounded-lg w-fit">
                ...
                <Button
                  ...
                  title={
                    selectedExchange === 'upbit' ? 'Upbit only supports spot markets' : ''
                  }
                >
                  Perpetual
                </Button>
        ...
        <Card className="glass border-white/5 border-dashed">
          <CardContent className="py-24 text-center">
            ...
            <p className="text-muted-foreground max-w-md mx-auto text-lg font-light">
              Choose an exchange and symbol above to view the real-time order book with market depth visualization.
            </p>
          </CardContent>
        </Card>
      )}

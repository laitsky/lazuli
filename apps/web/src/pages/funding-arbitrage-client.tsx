          ...
          {sortedRates.map((rate, index) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {index > 0 && index < sortedRates.length - 1 && <div className="w-4 h-4" />}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground mt-1">
                <strong>Long Exchange</strong>: Open a long position here (lower funding, you
                receive payments). <strong>Short Exchange</strong>: Open a short position here
                (higher funding). The <strong>Spread</strong> is your potential profit per funding
                period.
              </p>
            </div>
          </div>

...
export const appRoutes = {
  ...
  signalLab: {
    href: '/signal-lab',
    label: 'Signal Lab',
    description: 'Ranked live trade setups',
    icon: Crosshair,
  ...
  institutional: {
    href: '/institutional',
    label: 'Institutional',
    description: 'ETF, options, funding, and spot confluence',
    icon: Activity,
    keywords: ['institutional', 'etf', 'options', 'flow', 'vol', 'confluence', 'radar'],
    section: 'strategies',
  },
  etfFlows: {
    href: '/etf-flows',
    label: 'ETF Flows',
    description: 'Spot ETF flow terminal',
    icon: Landmark,
    keywords: ['etf', 'flows', 'ibit', 'fbtc', 'gbtc', 'etha', 'feth'],
    section: 'strategies',
  },
  optionsSurface: {
    href: '/options',
    label: 'Options',
    description: 'Options chain, IV, skew, and strike walls',
    icon: Waves,
    keywords: ['options', 'deribit', 'iv', 'skew', 'expiry', 'max pain'],
    section: 'strategies',
  },
  funding: {
    href: '/funding',
...
export const legacyRouteAliases: Record<string, string> = {
  ...
  '/strategies/signal-lab': appRoutes.signalLab.href,
  '/strategies/institutional': appRoutes.institutional.href,
  '/strategies/etf-flows': appRoutes.etfFlows.href,
  '/strategies/options': appRoutes.optionsSurface.href,
